/*
    ...
    OpenGL loader generated by glad 0.1.33 on Wed Jun 24 18:30:33 2020.
...
PFNGLGETPROGRAMIVPROC program = NULL;
...
static void load_GL_VERSION_2_0(GLADloadproc load) {
	...
	program = (PFNGLGETPROGRAMIVPROC)load("glGetProgramiv");
